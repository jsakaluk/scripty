#' Calculates unsigned difference in expected indicator scores for Group 2
#'
...
#'
get_udi2 <- function(dat, fit, nodewidth = 0.01, lowerLV = -5, upperLV = 5){
